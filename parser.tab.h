...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    COMA = 280,                    /* COMA  */
    JOIN_STRING = 281,             /* JOIN_STRING  */
    ARRAY_INDEX = 282,             /* ARRAY_INDEX  */
    FUNC_LENGTH = 283,             /* FUNC_LENGTH  */
    FUNC_ADD = 284,                /* FUNC_ADD  */
    MAIN_STRING = 285,             /* MAIN_STRING  */
    FLOAT_SUFFIX = 286,            /* FLOAT_SUFFIX  */
    LOGIC_NOT = 287,               /* LOGIC_NOT  */
    INT_NUMBER = 288,              /* INT_NUMBER  */
    OP_MENOR_A = 289,              /* OP_MENOR_A  */
    OP_MAYOR_A = 290,              /* OP_MAYOR_A  */
    FLOAT_NUMBER = 291,            /* FLOAT_NUMBER  */
    STRING_COMILLAS = 292,         /* STRING_COMILLAS  */
    PARSE_INT = 293,               /* PARSE_INT  */
    PARSE_FLOAT = 294,             /* PARSE_FLOAT  */
    PARSE_DOUBLE = 295,            /* PARSE_DOUBLE  */
    PARSE_STRING = 296,            /* PARSE_STRING  */
    BOOL_VALUE = 297,              /* BOOL_VALUE  */
    NULL_VALUE = 298,              /* NULL_VALUE  */
    OP_MENOR_IGUAL_A = 299,        /* OP_MENOR_IGUAL_A  */
    OP_MAYOR_IGUAL_A = 300,        /* OP_MAYOR_IGUAL_A  */
    OP_IGUAL_IGUAL = 301,          /* OP_IGUAL_IGUAL  */
    OP_DISTINTO_A = 302,           /* OP_DISTINTO_A  */
    LOGIC_AND = 303,               /* LOGIC_AND  */
    LOGIC_OR = 304,                /* LOGIC_OR  */
    IDENTIFICADOR = 305,           /* IDENTIFICADOR  */
    S_IGUAL = 306,                 /* S_IGUAL  */
    OP_MAS_IGUAL = 307,            /* OP_MAS_IGUAL  */
    OP_MENOS_IGUAL = 308,          /* OP_MENOS_IGUAL  */
    OP_MULTI_IGUAL = 309,          /* OP_MULTI_IGUAL  */
    OP_DIV_IGUAL = 310,            /* OP_DIV_IGUAL  */
    OP_MOD_IGUAL = 311,            /* OP_MOD_IGUAL  */
    OP_AND_IGUAL = 312,            /* OP_AND_IGUAL  */
    OP_OR_IGUAL = 313,             /* OP_OR_IGUAL  */
    OP_POT_IGUAL = 314,            /* OP_POT_IGUAL  */
