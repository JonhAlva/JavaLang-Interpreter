...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    COMA = 281,                    /* COMA  */
    JOIN_STRING = 282,             /* JOIN_STRING  */
    ARRAY_INDEX = 283,             /* ARRAY_INDEX  */
    FUNC_LENGTH = 284,             /* FUNC_LENGTH  */
    FUNC_ADD = 285,                /* FUNC_ADD  */
    MAIN_STRING = 286,             /* MAIN_STRING  */
    FLOAT_SUFFIX = 287,            /* FLOAT_SUFFIX  */
    LOGIC_NOT = 288,               /* LOGIC_NOT  */
    INT_NUMBER = 289,              /* INT_NUMBER  */
    OP_MENOR_A = 290,              /* OP_MENOR_A  */
    OP_MAYOR_A = 291,              /* OP_MAYOR_A  */
    FLOAT_NUMBER = 292,            /* FLOAT_NUMBER  */
    STRING_COMILLAS = 293,         /* STRING_COMILLAS  */
